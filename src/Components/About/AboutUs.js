        ...
        <Container fluid className='about_us_container' >
            ...
            <Row className='about_us_row_p'>
                <Col xl={9} xs={10} className='about_us_col_p'>
                    ...
                    <p>We have a team of 6 enthusiastic and versatile experienced people in areas like Project Management, Development, Designing, Architect, Digital Marketing and Content Writing. We as a team provide IT consultations & services from concept stage to production in live market and further maintenance.</p>
                    ...
                    <p>Samudayah works with a Vision for all our customers.We understand and support in customer business issues and provide a cost-effective solution. </p>
                    <p>Our Vision is, Valuing customer ideas and business to core by providing cost effective solutions.</p>
                </Col>
            </Row>
            <Row className='about_us_row_text1' >
                <Col className='about_us_col_text_p' xl={3} >
                    ...
                    <span className='about_us_text_span' >Creative Unique Designers.</span>
                    <p className='about_us_text_p' >We create the best-in-class, Web apps, web designs - combining strategical skills with design and technology,that are effective and impressive with the client's target market.</p>
                </Col>
                <Col className='about_us_col_text_p' xl={3} >
